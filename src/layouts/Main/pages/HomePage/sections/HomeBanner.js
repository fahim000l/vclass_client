  ...
  return (
    ...
    >
      ...
      <div className="card-body lg:w-[60%] text-start font-semibold">
        ...
        <p>
          VClass is an all-in-one virtual classroom solution that brings the
          best of traditional education into the digital era. Our platform
          combines state-of-the-art features with user-friendly design to create
          a seamless and immersive learning experience for students and
          educators alike.
        </p>
        {/* <div>
          <HomeStat />
